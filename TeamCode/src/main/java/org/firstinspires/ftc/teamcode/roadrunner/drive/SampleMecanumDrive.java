...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(20, 80, 0.1);

    public static double LATERAL_MULTIPLIER = 0.9929;

    // TODO: VX, VY and OMEGA should probably be changed
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        // Deleted IMU code as per https://learnroadrunner.com/dead-wheels.html#tuning-three-wheel
        // Byran 12.20.22
        ...
        // If not reversed, the robot will spin in place despite the code telling it to go forwards
        leftFront.setDirection(DcMotorSimple.Direction.REVERSE);
        leftRear.setDirection(DcMotorSimple.Direction.REVERSE);

        // If desired, use setLocalizer() to change the localization method
        // for instance, setLocalizer(new ThreeTrackingWheelLocalizer(...));
        // 3 dead wheel tracking localizer
    ...
    // Functions that get IMU values, return 0 since not used as per https://learnroadrunner.com/dead-wheels.html#tuning-three-wheel
    // Byran 12.20.22
    @Override
